...
def perform_library_operation():
    ...
    operation_choice = input('1) Take out book, \n'
                                 ...
                                 '5) Check how much you owe due to fines?\n'
                                    '6) Add a new user?')
    # while loop - take operation input and ask for new number if above 6.
    ...
    if operation_choice== 1:
        ...
        # add an item.
        item = input('Please input the item title?')
        item_type = input('What type of item is it? (DVD, book, journal)')
