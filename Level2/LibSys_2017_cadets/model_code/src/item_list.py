...
class ItemList(list):
    ...
    def get_item(self, identifier):
        ...
        """
        # TODO split getting item into two methods depending on identifier type
        ...
        raise ItemNotFoundException('No item found with ' + identifier_type + ' ' +
                        str(identifier))
