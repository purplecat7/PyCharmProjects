...
class User(object):
    ...
    def able_to_borrow(self, max_number_loans, max_total_fine):
        ...
        :rtype: bool
        """
        current_fines = self._user_items.get_fines()
        current_fines += self._fines
        current_loans = self._user_items.number_of_items()
    ...
    def checkout_item(self, item_requested, date=False):
        ...
        :return: no return
        """
        self._user_items.checkout_item(item_requested, date)
    ...
    def return_item(self, item_id):
        ...
        :return: no return
        """
        fine_due = self._user_items.return_item(item_id)
        self._fines += fine_due
